(function (global, factory) {
	...
	(factory((global.ReactOnVisible = global.ReactOnVisible || {}),global.React));
...
var OnVisible = function (_Component) {
    inherits(OnVisible, _Component);

    function OnVisible() {
        classCallCheck(this, OnVisible);

        var _this = possibleConstructorReturn(this, (OnVisible.__proto__ || Object.getPrototypeOf(OnVisible)).apply(this, arguments));

        _this.onScroll = debounce(_this.onScroll.bind(_this), 10);
        _this.state = {
            visible: false,
            bottom: 0,
            top: 0
    ...
    createClass(OnVisible, [{
        ...
        value: function onScroll() {
            ...
            var containerIsWindow = this.props.container === window;

            var horizontal = this.props.horizontal;

            var pos = horizontal ? window.pageXOffset + window.innerWidth : window.pageYOffset + window.innerHeight;
            ...
            var docLeft = document.documentElement.clientLeft || 0;

            var top = horizontal ? box.left + box.width * visbleTriggerRatio + (pageXOffset - docLeft) : box.top + box.height * visbleTriggerRatio + (pageYOffset - docTop);
        ...
        value: function render() {
            ...
            var classes = index$1(this.props.className, defineProperty({}, this.props.visibleClassName || 'visible', visible));
...
OnVisible.propTypes = {
    ...
    style: index.object,
    visibleClassName: index.string,
    horizontal: index.bool,
    event: index.string,
    children: index.node,
